...
public class EvaluateAgainstQALD implements Constants{
    ...
    public EvaluateAgainstQALD(Map<String, String[]> questions,String language, String endpoint, Set<String> menu, String FIND_SIMILARITY_RESULT, String resultComparisonFile, String qaldAnswerFile, String qaldQueGGAnswerFile,Boolean online) {
    ...
    public void evaluateAndOutput(String qaldOriginalFile, String qaldModifiedFile, String qaldRaw, String languageCode, Double similarityMeasure) throws IOException, Exception {
