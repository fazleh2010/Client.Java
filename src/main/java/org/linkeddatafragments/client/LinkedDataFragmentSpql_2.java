 ...
 * @author elahi
 */
public class LinkedDataFragmentSpql_2 {
    private static LinkedHashSet<String> classNames=new LinkedHashSet<String>();



     static{
       classNames.add("Organisation");
       classNames.add("Company");
       classNames.add("Actor");
       classNames.add("Athlete");
       classNames.add("MilitaryPerson");
       classNames.add("Politician");
       classNames.add("Writer");
    ...
    public LinkedDataFragmentSpql_2(String queryString,String fileName,String className) {
    ...
    public LinkedDataFragmentSpql_2(Model modelT, String endpoint, String queryString,String fileName) {
        //model = modelT;
