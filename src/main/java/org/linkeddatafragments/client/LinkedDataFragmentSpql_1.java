 ...
 * @author elahi
 */
public class LinkedDataFragmentSpql_1 {
    ...
    public static void main(String[] args) {
        ...
        //String className="City";
        LinkedDataFragmentSpql LinkedDataFragmentSpql = new LinkedDataFragmentSpql(queryString,fileName,className);

    }

    public LinkedDataFragmentSpql_1(String queryString,String fileName,String className) {
    ...
    public LinkedDataFragmentSpql_1(Model modelT, String endpoint, String queryString,String fileName) {
        //model = modelT;
